...
export async function PATCH(
  ...
  try {
    ...
    const eventType =
      updatedStatus !== previousStatus ? "task.status_changed" : "task.updated";
    const message =
...
export async function DELETE(
  ...
  try {
    ...
    await db
      .delete(taskFingerprints)
      .where(eq(taskFingerprints.taskId, taskId));
    await db
      .delete(approvalTaskLinks)
      .where(eq(approvalTaskLinks.taskId, taskId));
    await db
