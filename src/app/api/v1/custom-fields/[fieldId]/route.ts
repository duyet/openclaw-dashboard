...
export async function PATCH(
  ...
  try {
    ...
    if (typeof body.field_type === 'string') updates.fieldType = body.field_type;
    if (typeof body.ui_visibility === 'string') updates.uiVisibility = body.ui_visibility;
    if (body.validation_regex !== undefined) updates.validationRegex = body.validation_regex || null;
    if (body.description !== undefined) updates.description = body.description || null;
    if (typeof body.required === 'boolean') updates.required = body.required;
    if (body.default_value !== undefined) {
      updates.defaultValue = body.default_value != null ? JSON.stringify(body.default_value) : null;
    }
