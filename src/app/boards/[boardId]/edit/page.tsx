          ...
          >
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <SearchableSelect
                  ...
                  itemClassName="px-4 py-3 text-sm text-foreground/90 data-[selected=true]:bg-accent/50 data-[selected=true]:text-foreground"
                />
              </div>
            </div>
            ...
            <section className="space-y-3 border-t border-border pt-4">
              ...
              <div className="flex items-start gap-3 rounded-lg border border-border px-3 py-3">
                ...
                >
                  <span
                    className={`inline-block h-5 w-5 rounded-full bg-background shadow-sm transition ${
                      resolvedRequireApprovalForDone
                        ? "translate-x-5"
                        : "translate-x-0.5"
                    }`}
        ...
        >
          <div className="flex">
            <DialogClose asChild>
              <button
                type="button"
                className="sticky top-4 z-10 ml-auto rounded-lg border border-border bg-card p-2 text-muted-foreground transition hover:bg-accent/50"
